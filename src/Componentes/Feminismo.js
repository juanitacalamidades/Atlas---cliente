...
const Feminismo =(props)=>{
        ...
        if(libro.materia === "Feminismo"){
            ...
            return (
             ...
             <Container>
                    ...
                    <Col md="30"></Col>
                    <Col xs lg="30">
                    <div className="sinestilo elementos-libros" sm>{libro.titulo}</div>
    ...
    return (
        <>
        <h3 className="sinestilo fondo-seccion">Feminismo</h3>
        <div> {libros}</div> 
