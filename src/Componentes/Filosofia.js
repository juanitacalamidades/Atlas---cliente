...
const Filosofia =(props)=>{
    ...
    const libros = data.map(libro => {
        if(libro.materia === "Filosofía"){
    
            return (
                <>
                    <Container>
                    <Row className="justify-content-md-center">
                    <Col xs lg="2"><div className="elementos-libro"><img src={libro.img} alt="" className="img-secciones"/></div></Col>
                    <Col md="30"></Col>
                    <Col xs lg="30">
...
<h3 className="sinestilo fondo-seccion">Filosofía</h3>
